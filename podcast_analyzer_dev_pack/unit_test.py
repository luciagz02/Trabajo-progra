...
class AppTest(unittest.TestCase): 
    ...
    def test_analyze_dataset(self):
        ...
        self.assertTrue(len(observations)==3263)
    ...
    def test_generate_stats(self):
        ...
        self.assertTrue(stats["Download 200"]==50)
        self.assertTrue(stats["Download 206"]==2332)
    ...
    def test_list_top_k_programs(self):
        ...
        self.assertTrue(top_k[0][1]==496)
        self.assertTrue(top_k[1][1]==233)
        self.assertTrue(top_k[2][1]==176)
